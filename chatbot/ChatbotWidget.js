...
const ChatbotWidget = ({
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const conversationHistory = [...systemInstruction, ...messages.filter(msg => msg.type !== 'thinking' && !msg.isLeadReminder).map(msg => ({
      ...
      if (data.success && data.response) {
        ...
        const botResponseCount = messages.filter(msg => msg.type === 'bot' && !msg.isWelcome && !msg.isError && !msg.isLeadReminder).length + 1; // +1 for the one we're about to add
  ...
  })), slowResponse && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '8px',
      fontSize: '12px',
      color: '#71717a',
  ...
  }, t.stillWorking))), /*#__PURE__*/React.createElement("div", {
    ref: messagesEndRef
  })), /*#__PURE__*/React.createElement("div", {
